...
$(document).ready(function () {
    ...
    // Here be graphs
    function createGraph(data, container, selectedState) {
    ...
    $('#NewYork,#NewYork1').mouseover(
function () {
    createGraph('#data-table', '.chart', '.NY');
}
).mouseout(function () {
    $('#figure').empty();
}
...
$('#California,#California1').mouseover(
function () {
...
$("#Arizona,#Arizona1").mouseover(
function () {
    createGraph('#data-table', '.chart', '.WA');
}
).mouseout(function () {
    $('#figure').empty();
}
    ...
    $('#Texas,#Texas1').mouseover(
function () {
    createGraph('#data-table', '.chart', '.TX');
}
).mouseout(function () {
    $('#figure').empty();
}
...
$('#Alabama,#Alabama1').mouseover(
function () {
    createGraph('#data-table', '.chart', '.DT');
}
).mouseout(function () {
    $('#figure').empty();
}
